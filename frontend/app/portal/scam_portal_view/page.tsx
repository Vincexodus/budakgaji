      ...
      {!submitted ? (
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="border-b pb-4">
            <h2 className="text-xl font-semibold mb-4 text-gray-600">1. Scam Details</h2>
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <Label className="text-gray-400">Date of Scam</Label>
              ...
              <div>
                <Label className="text-gray-400">Type of Scam</Label>
                <Select 
                  name="scamType"
                ...
                >
                  <SelectTrigger className="text-gray-500">
                    <SelectValue className="text-gray-300" placeholder="Select Scam Type" />
                  </SelectTrigger>
                  <SelectContent >
              ...
              <div>
                <Label className="text-gray-400">Communication Method</Label>
                <Select 
                ...
                >
                  <SelectTrigger className="text-gray-500">
                    <SelectValue className="text-gray-300" placeholder="Select Method" />
                  </SelectTrigger>
                  <SelectContent>
